...
<div id="phone" class="phone hidden">
	...
	<div class="menu-overlay">
		<a href="#" onclick="ChangeContent(0);">Pabellon 360</a>
		<hr>
...
<div id="desktop" class="desktop hidden">
	...
	<div id="divmenu" class="close-wrapper hidden">
	    <div class="menu" onclick="CloseOverlay()">

	      <div class="bar one animation"></div>
	      <div class="bar two animation"></div>
	    </div>
	  </div>
